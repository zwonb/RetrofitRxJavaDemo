...
//        ComLog.E(plainText);
        Key deskey = null;
        DESedeKeySpec spec = new DESedeKeySpec(HttpConfig.THREEDES_SECRETKEY.getBytes());
        SecretKeyFactory keyfactory = SecretKeyFactory.getInstance("desede");
        deskey = keyfactory.generateSecret(spec);

        Cipher cipher = Cipher.getInstance("desede/CBC/PKCS5Padding");
        IvParameterSpec ips = new IvParameterSpec(HttpConfig.THREEDES_IV.getBytes(encoding));
...
//        des = des.replaceAll("\\+", "%2B");
    ...
    public static String decode(String encryptText) throws Exception {
        ...
        deskey = keyfactory.generateSecret(spec);
        Cipher cipher = Cipher.getInstance("desede/CBC/PKCS5Padding");
        IvParameterSpec ips = new IvParameterSpec(HttpConfig.THREEDES_IV.getBytes("utf-8"));
